...
public class WfTaskProcessor extends WorkflowProcessor implements Evolvable {
	...
	public void activityAttributes(Properties var1, Locale var2, OutputStream var3)
		...
		if (this.workItemExists()) {
			...
			String var10001 = this.tableCellBold(this.getProcessInitiatorLabel(var2), 1);
			var4.println("<TR>" + var10001);
			var4.println(this.tableCell(this.translateToHtml(this.getProcessInitiator())));
			var10001 = this.tableCellBold(this.getDueDateLabel(var2), 1);
			var4.println("<TR>" + var10001);
			var4.println(this.tableCell(this.translateToHtml(this.getDueDate(var2))));
			var10001 = this.tableCellBold(this.getWorkItemRoleLabel(var2), 1);
			var4.println("<TR>" + var10001);
			var4.println(this.tableCell(this.translateToHtml(this.getWorkItemRole(var2))));
			var10001 = this.tableCellBold(this.getAssigneeLabel(var2), 1);
			var4.println("<TR>" + var10001);
			String var10003 = this.getAssignee();
			var4.println(this.tableCell(this.translateToHtml(var10003 + this.getOriginalOwnerLocal())));
			var4.println("</TABLE>");
			if (!this.contextSet) {
	...
	public void projectLinkActivityAttributes(Properties var1, Locale var2, OutputStream var3)
		...
		var5.println("<table border=\"0\" cellpadding=\"3\" cellspacing=\"0\">");
		var5.println("<tr><td colspan=\"2\"><hr size=\"1\" color=\"#40637A\"></td></tr>");
		String var6 = WorkflowHtmlUtil.getExternalTaskURL(this.getWorkItem());
		if (var6 != null) {
			String var7 = this
			...
			String var10000 = HTMLEncoder.encodeForHTMLAttribute(var6);
			String var10 = "<A id=\"WfExternalTaskTProcessor02\" HREF=\"" + var10000 + "\">"
					+ HTMLEncoder.encodeForHTMLContent(this.myActivity.getName()) + "</A>";
			var5.println(this.translateToHtml(var10 + var8));
			var5.println("</font></td></tr>");
			var10000 = this.getTaskUrl(this.getContextRef());
			String var11 = "<A id=\"WfExternalTaskTProcessor03\" HREF=\"" + var10000 + "\">"
					+ HTMLEncoder.encodeForHTMLContent(this.myActivity.getName()) + "</A>";
			var5.println(
					"<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
			var5.println("");
			...
			var5.println(this.translateToHtml(var11 + var9));
			var5.println("</font></td></tr>");
		}

		var5.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var5.println(this.getActivityInstructionsLabel(var2));
		var5.println("</b></font></td>");
		var5.println("<td align=\"left\" colspan=\"4\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var5.println(this.getActivityInstructionsAsHtml());
		var5.println("</font></td></tr>");
		var5.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var5.println(this.getProcessInitiatorLabel(var2));
		var5.println("</b></font></td>");
		var5.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var5.println(this.translateToHtml(this.getProcessInitiator()));
		var5.println("</font></td></tr>");
		var5.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var5.println(this.getDueDateLabel(var2));
		var5.println("</b></font></td>");
		var5.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var5.println(this.getProjectLinkDueDate(var2));
		var5.println("</font></td></tr>");
		var5.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var5.println(this.getWorkItemRoleLabel(var2));
		var5.println("</b></font></td>");
		var5.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var5.println(this.getWorkItemRole(var2));
		var5.println("</font></td></tr>");
		var5.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var5.println(this.getAssigneeLabel(var2));
		var5.println("</b></font></td>");
		var5.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		String var10002 = this.getAssignee();
		var5.println(this.translateToHtml(var10002 + this.getOriginalOwnerLocal()));
		var5.println("</font></td></tr>");
		var5.println("<tr><td colspan=\"2\"><hr size=\"1\" color=\"#40637A\"></td></tr>");
	...
	public void plmLinkActivityAttributes(Properties var1, Locale var2, OutputStream var3)
			throws WTException, WTPropertyVetoException {
		String var4 = null;
		if (var1 != null) {
		...
		if (var5) {
			...
			String var10001 = this.getPriorityLabel(var2);
			var6.println("&nbsp;&nbsp;&nbsp;" + var10001);
			var6.println("</td>");
			var6.println("<td align=\"left\" valign=\"top\" class=\"propValue\">");
			...
			var6.println("<td align=\"left\" valign=\"top\" class=\"propValue\">");
			String var10002 = this.getAssignee();
			var6.println(this.translateToHtml(var10002 + this.getOriginalOwnerLocal()));
			var6.println("</td>");
			var6.println("<td align=\"right\" valign=\"top\" nowrap class=\"propTitle\">");
			var10001 = this.getDueDateLabel(var2);
			var6.println("&nbsp;&nbsp;&nbsp;" + var10001);
			var6.println("</td>");
			var6.println("<td align=\"left\" valign=\"top\" class=\"propValue\">");
			...
			var6.println("</td>");
			var6.println("<td align=\"right\" valign=\"top\" nowrap class=\"propTitle\">");
			var10001 = this.getProcessNameLabel(var2);
			var6.println("&nbsp;&nbsp;&nbsp;" + var10001);
			var6.println("</td>");
			var6.println("<td align=\"left\" valign=\"top\" class=\"propValue\">");
	...
	public void activityAttributesPlain(Properties var1, Locale var2, OutputStream var3)
		...
		String var10001 = this.trimHtml(this.getActivityInstructionsLabel(var2));
		var4.println(var10001 + var5);
		var10001 = this.trimHtml(this.getProcessNameLabel(var2));
		var4.println(var10001 + this.getProcess().getName() + " (" + this.stripHtmlFormat(this.getProcessName()) + ")");
		var10001 = this.trimHtml(this.getProcessInitiatorLabel(var2));
		var4.println(var10001 + this.stripHtmlFormat(this.getProcessInitiator()));
		String var6 = this.getDueDate(var2);
		if (var6 == null) {
			var6 = " ";
		}

		var10001 = this.trimHtml(this.getDueDateLabel(var2));
		var4.println(var10001 + var6);
		var10001 = this.trimHtml(this.getWorkItemRoleLabel(var2));
		var4.println(var10001 + this.getWorkItemRole(var2));
		var10001 = this.trimHtml(this.getAssigneeLabel(var2));
		var4.println(var10001 + this.stripHtmlFormat(this.getAssignee()));
		var4.flush();
	}
	...
	public void activityAttributesWithGroup(Properties var1, Locale var2, OutputStream var3)
		...
		var10001 = this.tableCellBold(this.getGroupLabel(var2), 1);
		var4.println("<TR>" + var10001);
	...
	public void processVariables(Properties var1, Locale var2, OutputStream var3) throws WTException {
		...
		String var10001 = this
				.columnLabel((new WTMessage("wt.workflow.worklist.worklistResource", "4", (Object[]) null))
						.getLocalizedMessage(var2));
		var4.println("<TR>" + var10001);
		var4.println(this.columnLabel((new WTMessage("wt.workflow.worklist.worklistResource", "5", (Object[]) null))
				.getLocalizedMessage(var2)));
		ProcessData var5 = this.getProcess().getContext();
		String[] var6 = var5.getNames();
		String[] var7 = var5.getDisplayNames(var2);

		for (int var8 = 0; var8 < var6.length; ++var8) {
			var5.getValue(var6[var8]);
			String var10 = var7[var8];
			if (var6[var8].equals("instructions")) {
				var10 = (new WTMessage("wt.workflow.worklist.worklistResource", "21", (Object[]) null))
						.getLocalizedMessage(var2);
			}

			if (var6[var8].equals("primaryBusinessObject")) {
				var10 = (new WTMessage("wt.workflow.worklist.worklistResource", "14", (Object[]) null))
						.getLocalizedMessage(var2);
			}

			if (!var6[var8].equals("self")) {
				var10001 = this.tableCell(var10);
				var4.println("<TR>" + var10001 + this.tableCell(this.getProcessVariableDisplay(var6[var8], var2)));
			}
		}
		...
		if (var3 == null) {
			...
			if (var3 instanceof ObjectReference) {
				...
				if (var3 instanceof Date) {
					var8 = ResourceBundle.getBundle("wt.util.utilResource", var2);
					var5 = var8.getString("22");
					return this.translateToHtml(WTStandardDateFormat.format((Date) var3, var5));
				} else if (var3 instanceof WfDueDate) {
					var8 = ResourceBundle.getBundle("wt.util.utilResource", var2);
					var5 = var8.getString("22");
					return this.translateToHtml(WTStandardDateFormat.format(((WfDueDate) var3).getDeadline(), var5));
				} else if (var3 instanceof URL) {
					return this.translateToHtml(var3 == null
							? null
							: HtmlUtil.createLink(((URL) var3).toExternalForm(), (String) null,
									((URL) var3).toExternalForm()));
				} else {
					String var7 = var3.toString();
					var7 = this.escapeHtml(var7);
					return this.translateToHtml(var7);
				}
			}
		}
	}
	...
	public void setContextObject(Properties var1, Locale var2, OutputStream var3) throws WTException {
		...
		if (var4.equals("process")) {
			...
			try {
				...
				this.setContextObj((WTObject) this.getProcess().getContext().getValue("primaryBusinessObject"));
			} finally {
	...
	public void processContent(Properties var1, Locale var2, OutputStream var3) throws WTException {
		...
		if (!this.isUpdateContentDisplayed() && !var5.equals("expand")) {
			...
			WfProcess var7 = this.getProcess();
			WTPrincipal var8 = SessionHelper.getPrincipal();
			if (AccessControlHelper.manager.hasAccess(var8, var7, AccessPermission.MODIFY)) {
				Object[] var9 = new Object[]{var7.getName()};
				String var10 = "";
				if (this.pdmlContext) {
					var10 = getContextActionLink(this.getURLProcessorLink("URLTemplateAction", (Properties) null, true),
							"contentUpdate", "updatingContent",
							(new WTMessage("wt.workflow.worklist.worklistResource", "164", (Object[]) null))
									.getLocalizedMessage(var2));
				} else {
					var10 = getContextActionLink(this.getURLProcessorLink("URLTemplateAction", (Properties) null),
							"contentUpdate", "updatingContent",
							(new WTMessage("wt.workflow.worklist.worklistResource", "118", var9))
									.getLocalizedMessage(var2));
				}
				...
				if (this.pdmlContext) {
					...
					var4.println("<IMG SRC=\"" + CODEBASE + "/" + UPDATE_CONTENT_GIF + "\" border=\"0\">&nbsp" + var10);
				}
			}
		} else {
			var4.println("");
			...
			if (this.showVariable(var4[var7].getName(), var4[var7].isVisible())) {
				...
				var1.write("<TR><TD VALIGN=top align=right class=\"propTitle\"><B><font class=tableWfHeader>" + var6
						...
						+ (new WTMessage("wt.workflow.worklist.worklistResource", "3", (Object[]) null))
								.getLocalizedMessage(var2)
						+ "</B></TD>");
				String var10001 = this.displayActivityVariable(var4[var7], var3, DEFAULT_ROW_NUMBER,
						DEFAULT_COLUMN_NUMBER, var2);
				var1.write("<TD VALIGN=top align=left class=\"propValue\"><font class=tableWfHeader>" + var10001
						+ "</TD></TR>\n");
			}
		}
		...
		if (this.isAdHocActivitiesInProgress()) {
			...
			if (((WfAssignedActivityTemplate) this.myActivity.getTemplateReference().getObject()).isSigningRequired()) {
				...
				if (var6 != null) {
					...
					for (int var9 = 0; var9 < var8.length; ++var9) {
						String var10002 = var8[var9].isRequired() ? "*" : "&nbsp;";
						String var10001 = this.formatLabel(var10002 + var8[var9].getLabel().getLocalizedMessage(var2));
						var4.print("<font face=\"arial, helvetica\" size=\"2\"><B>" + var10001 + "</B>");
						...
						int var10 = var8[var9].getPreferredSize() < 40 ? var8[var9].getPreferredSize() : 40;
						var4.print(" size=\"" + var10 + "\" AUTOCOMPLETE=\"OFF\">");
						var4.println("<BR>");
					}
		...
		if (this.showVariable(var6, var1.isVisible())) {
			...
			try {
				...
				if (WTObject.class.isAssignableFrom(var8)) {
					...
					if (var9.equals("wt.team.Team")) {
						...
						if (var2.getValue(var6) != null) {
							...
							TeamReference var28 = TeamReference.newTeamReference((Team) var2.getValue(var6));
							var13 = var28.getIdentity();
						}

						var31 = TeamHelper.service.findTeams();
						var27 = new ReferenceFactory();
						var17 = new Vector(var31.size());
						var18 = new Vector(var31.size());
						var19 = 0;
						var22 = !var1.isRequired();

						for (var23 = 0; var23 < var31.size(); ++var23) {
							TeamReference var30 = (TeamReference) var31.elementAt(var23);
							var21 = var27.getReferenceString(var30);
							var17.addElement(var21);
							var20 = var30.getIdentity();
							var18.addElement(var20);
							if (var13 != null && var13.equals(var20)) {
								var19 = var23;
								if (var22) {
									var19 = var23 + 1;
								}
						...
						return HtmlUtil.createSelectHTML(var6, (String) null, var17, var18, var22, var19);
					}

					if (var9.equals("wt.team.TeamTemplate")) {
						if (var1.isReadOnly()) {
							return this.translateToHtml(var2.getValue(var6) == null
									? null
						...
						if (var2.getValue(var6) != null) {
							new ReferenceFactory();
							TeamTemplateReference var26 = TeamTemplateReference
									.newTeamTemplateReference((TeamTemplate) var2.getValue(var6));
							var13 = var26.getIdentity();
						}

						var31 = TeamHelper.service.findTeamTemplates(var11);
						var27 = new ReferenceFactory();
						var17 = new Vector(var31.size());
						var18 = new Vector(var31.size());
						var19 = 0;
						...
						for (var23 = 0; var23 < var31.size(); ++var23) {
							TeamTemplateReference var29 = (TeamTemplateReference) var31.elementAt(var23);
							var21 = var27.getReferenceString(var29);
							var17.addElement(var21);
							var20 = var29.getIdentity();
							var18.addElement(var20);
							if (var13 != null && var13.equals(var20)) {
								var19 = var23;
								if (var22) {
				...
				if (EnumeratedType.class.isAssignableFrom(var8)) {
					...
					EnumeratedType var25 = null;
					if (var2.getValue(var6) != null) {
						var25 = (EnumeratedType) var2.getValue(var6);
					}

					if (this.getFormData() != null && this.getFormData().getProperty(var6) != null
							&& this.getFormData().getProperty(var6).length() > 0) {
						var25 = EnumeratedTypeUtil.toEnumeratedType(var1.getTypeName(),
								this.getFormData().getProperty(var6));
					}

					return this.enumeratedTypeSelector(var8, var25, var6, var5);
				}
				...
				if (!var1.getTypeName().equals("java.lang.Boolean") && !var1.getTypeName().equals("boolean")) {
					if (var1.getTypeName().equals("java.net.URL")) {
						...
						if (var1.getTypeName().equals("java.util.Date")) {
							...
							return var1.isReadOnly()
									? this.translateToHtml(var14)
	...
	public void taskURL(Properties var1, Locale var2, OutputStream var3, WTContainerRef var4) throws WTException {
		...
		if (var8 != null) {
			String var10000 = HTMLEncoder.encodeForHTMLContent(var8);
			String var9 = "<A id=\"WfExternalTaskTProcessor02\" HREF=\"" + var10000 + "\">"
					+ HTMLEncoder.encodeForHTMLContent(this.myActivity.getName()) + "</A>";
			String var10 = this.formatLabel(
					(new WTMessage("wt.workflow.worklist.worklistResource", "NAVIGATE_LABEL", (Object[]) null))
							.getLocalizedMessage(var2));
			String var11 = this.formatLabel(
					(new WTMessage("wt.workflow.worklist.worklistResource", "WINDCHILL_LABEL", (Object[]) null))
							.getLocalizedMessage(var2));
			var5.println(var9 + "(" + var10 + ")");
			var5.println("<br>");
			var5.println(var6 + "(" + var11 + ")");
		} else {
			var5.println(var6);
		}
	...
	public void getHelpURL(Properties var1, Locale var2, OutputStream var3) throws WTException {
		...
		if (var5 == null) {
			...
			try {
				var10001 = CODEBASE;
				var4.println(var10001 + "/" + WTMessage.getLocalizedMessage(var6, var5, (Object[]) null, var2));
			} catch (MissingResourceException var8) {
				Logger var10000 = logger;
				var10001 = var8.getMessage();
				var10000.error("*ERROR* " + var10001 + ": {" + var8.getClassName() + " - " + var8.getKey() + "}");
				throw var8;
			}
	...
	public String principalSelector(String var1, WTPrincipal var2, String var3) throws WTException {
		...
		if (var1.equals("wt.org.WTPrincipal") || var1.equals("wt.org.WTUser")) {
			var7 = (Vector) MethodContext.getContext().get("WF_USERS");
			var8 = (Vector) MethodContext.getContext().get("WF_DISPLAY_USERS");
			if (var7 != null && var8 != null) {
				var5 = var7;
				var4 = var8;
			} else {
				HashMap var9 = new HashMap();
				var9.put("name", new ArrayList(Arrays.asList("*")));
				Enumeration var10 = OrganizationServicesHelper.manager.queryPrincipals(WTUser.class, var9);
				SortedEnumByPrincipal var11 = new SortedEnumByPrincipal(var10, false, 1);

				while (var11.hasMoreElements()) {
					WTUser var6 = (WTUser) var11.nextElement();
					var4.addElement(var6.getName());
					var5.addElement(SortedEnumByPrincipal.getLastNameFirstName(var6));
				}
		...
		if (var1.equals("wt.org.WTPrincipal") || var1.equals("wt.org.WTGroup")) {
			var7 = (Vector) MethodContext.getContext().get("WF_GROUPS");
			var8 = (Vector) MethodContext.getContext().get("WF_DISPLAY_GROUPS");
			if (var7 != null && var8 != null) {
				var5 = var7;
				var4 = var8;
			} else {
				SortedEnumeration var14 = new SortedEnumeration(OrganizationServicesMgr.allGroups(),
						new CollationKeyFactory(WTContext.getContext().getLocale()));

				while (var14.hasMoreElements()) {
					WTGroup var12 = (WTGroup) var14.nextElement();
					var4.addElement(var12.getName());
					var5.addElement(var12.getName());
				}
	...
	public void projectLinkAttributes(Properties var1, Locale var2, OutputStream var3, Project2 var4)
			throws WTException, WTPropertyVetoException {
		PrintWriter var6 = this.getPrintWriter(var3, var2);
		NetmarketsHref var7 = new NetmarketsHref(
				(new ReferenceFactory()).getReference(var4.getPersistInfo().getObjectIdentifier().getStringValue()));
		var7.setFullyQualified(true);
		String var8 = var7.getHref();
		if (logger.isDebugEnabled()) {
			Logger var10000 = logger;
			String var10001 = HtmlUtil.createInlineLink(var8, "", var4.getName());
			var10000.debug("   .....Project: " + var10001);
		}
		...
		if (var4.getOwnerReference() != null) {
			...
			var6.println(var4.getOwnerReference().getFullName() + "</a>");
		} else {
			var6.println(WTMessage.getLocalizedMessage("wt.workflow.worklist.worklistResource", "204", (Object[]) null,
					var2));
		}
		...
		var6.println("</b></font></td>");
		var6.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		OrgContainer var9 = WTContainerHelper.service.getOrgContainer(var4);
		var6.println(var9 != null ? var9.getName() : "&nbsp;");
		var6.println("</font></td></tr>\n");
		if (logger.isDebugEnabled()) {
		...
		var6.println("</b></font></td>");
		var6.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		String var10 = var4.getDescription();
		if (var10 != null && var10.trim().length() > 0) {
			var6.println(this.translateToHtml(var10));
		} else {
			var6.println(WTMessage.getLocalizedMessage("wt.workflow.worklist.worklistResource", "204", (Object[]) null,
					var2));
		}
	...
	public void enterComments(Properties var1, Locale var2, OutputStream var3) throws WTException {
		...
		if (((WfAssignedActivityTemplate) var4.getTemplateReference().getObject()).isSigningRequired()) {
			...
			PrintWriter var6 = this.getPrintWriter(var3, var2);
			String var10001 = (new WTMessage("wt.lifecycle.lifecycleResource", "99", (Object[]) null))
					.getLocalizedMessage(var2);
			var6.println(var10001 + (new WTMessage("wt.lifecycle.lifecycleResource", "150", (Object[]) null))
	...
	public boolean isWorkItemOwner() {
		...
		try {
			...
			if (logger.isDebugEnabled()) {
				...
				var10000.debug("=> WfTaskProcessor.isWorkItemOwnwer" + var10001 + " is " + (var1 ? "" : " not")
						+ "the owner of " + var3);
			}
	...
	public void notificationActivityAttributes(Properties var1, Locale var2, OutputStream var3)
			throws WTException, WTPropertyVetoException {
		...
		PrintWriter var7 = this.getPrintWriter(var3, var2);
		var7.println("<table border=\"0\" cellpadding=\"3\" cellspacing=\"0\">");
		var7.println("<tr><td colspan=\"2\"><hr size=\"1\" color=\"#40637A\"></td></tr>");
		String var8 = WorkflowHtmlUtil.getExternalTaskURL(this.getWorkItem());
		if (var8 != null) {
			String var9 = this
					.formatLabel((new WTMessage("wt.workflow.worklist.worklistResource", "40", (Object[]) null))
							.getLocalizedMessage(var2));
			...
			var7.println(
					"<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
			var7.println(var9);
			var7.println("</b></font></td>");
			var7.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
			String var10000 = HTMLEncoder.encodeForHTMLAttribute(var8);
			String var12 = "<A id=\"WfExternalTaskTProcessor02\" HREF=\"" + var10000 + "\">"
					+ HTMLEncoder.encodeForHTMLContent(this.myActivity.getName()) + "</A>";
			var7.println(this.translateToHtml(var12 + var10));
			var7.println("</font></td></tr>");
			var10000 = this.getTaskUrl(this.getContextRef());
			String var13 = "<A id=\"WfExternalTaskTProcessor03\" HREF=\"" + var10000 + "\">"
					+ HTMLEncoder.encodeForHTMLContent(this.myActivity.getName()) + "</A>";
			var7.println(
					"<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
			var7.println("");
			var7.println("</b></font></td>");
			var7.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
			var7.println(this.translateToHtml(var13 + var11));
			var7.println("</font></td></tr>");
		}

		var7.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var7.println(this.getActivityInstructionsLabel(var2));
		var7.println("</b></font></td>");
		var7.println("<td align=\"left\" colspan=\"4\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		WTPrincipal var21 = SessionContext.getEffectivePrincipal();

		try {
			SessionContext.setEffectivePrincipal(this.getWorkItem().getOwnership().getOwner().getPrincipal());
			var7.println(this.getActivityInstructionsAsHtml());
		} catch (Exception var17) {
			throw new WTException(var17);
		} finally {
			SessionContext.setEffectivePrincipal(var21);
		}
		...
		if (var5 != null) {
			var7.println(
					"<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
			var7.println(this.getRequestedPromotionStateLabel(var2));
			var7.println("</b></font></td>");
			var7.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
			var7.println(this
		...
		var7.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var7.println(this.getProcessInitiatorLabel(var2));
		var7.println("</b></font></td>");
		var7.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var7.println(this.translateToHtml(HTMLEncoder.encodeAndFormatForHTMLContent(this.getProcessInitiator())));
		var7.println("</font></td></tr>");
		var7.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var7.println(this.getDueDateLabel(var2));
		var7.println("</b></font></td>");
		var7.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var7.println(this.getDueDate(var2));
		var7.println("</font></td></tr>");
		var7.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var7.println(this.getWorkItemRoleLabel(var2));
		var7.println("</b></font></td>");
		var7.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var7.println(this.getWorkItemRole(var2));
		var7.println("</font></td></tr>");
		var7.println("<tr><td align=\"right\" valign=\"top\" nowrap><font face=\"Arial, Helvetica, sans-serif\"><b>");
		var7.println(this.getAssigneeLabel(var2));
		var7.println("</b></font></td>");
		var7.println("<td align=\"left\" valign=\"top\"><font face=\"Arial, Helvetica, sans-serif\">");
		var7.println(this.translateToHtml(HTMLEncoder.encodeAndFormatForHTMLContent(this.getAssignee())));
		var7.println("</font></td></tr>");
		var7.println("<tr><td colspan=\"2\"><hr size=\"1\" color=\"#40637A\"></td></tr>");
		Object var19 = this.getContextObj();
		this.setContextObj(this.getActivity());
		Properties var20 = new Properties();
		var20.put("service", "wt.workflow.work.WorkProcessorService");
		var20.put("method", "projectLinkAttributes");
		this.useProcessorService(var20, var2, var3);
		this.setContextObj(var19);
		var7.println("</table>");
		var7.flush();
	}

	public void activityNotificationUrl(Properties var1, Locale var2, OutputStream var3) throws WTException, WTPropertyVetoException {
      String var4 = null;
      PrintWriter var5 = this.getPrintWriter(var3, var2);
      if (this.workItemExists()) {
         String var6 = "";
         ...
         if (var8 != null && var8.getObject() != null) {
            ...
            Object[] var10 = new Object[]{this.getPrincipalEmailLink(var9, (String)null)};
            var6 = (new WTMessage("wt.workflow.worklist.worklistResource", "206", var10)).getLocalizedMessage(var2);
            String var10000 = this.translateToHtml(var6);
            var6 = var10000 + "<BR><BR>";
         }

         String var12 = WorkflowHtmlUtil.getExternalTaskURL(var7);
         var6.makeConcatWithConstants<invokedynamic>(var6, this.translateToHtml(var4));
         if (var12 != null) {
            var4 = (new WTMessage("wt.workflow.worklist.worklistResource", "NOTIFICATION_EXTERNAL_TASK_LABEL", (Object[])null)).getLocalizedMessage(var2);
            var5.println(var6 + var4);
            var5.println("<br>");
         } else {
            Object[] var11 = new Object[]{this.getTaskUrl(this.getContextRef()), HTMLEncoder.encodeAndFormatForHTMLContent(this.getActivity().getName())};
            var4 = (new WTMessage("wt.workflow.worklist.worklistResource", "205", var11)).getLocalizedMessage(var2);
            var5.println(var6 + this.translateToHtml(var4));
         }
      } else {
         var4 = (new WTMessage("wt.workflow.worklist.worklistResource", "230", new Object[0])).getLocalizedMessage(var2);
	...
	protected WTContainerRef getContextRef() throws WTException {
		...
		if (var1 instanceof WTContained) {
			var2 = ((WTContained) var1).getContainerReference();
		}
