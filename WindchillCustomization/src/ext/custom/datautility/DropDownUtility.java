...
//This is just for learning combobox,create,edit mode etc..Dont take it as a practical example
public class DropDownUtility extends DefaultDataUtility {
	...
	public Object getDataValue(String componentId, Object datum, ModelContext modelContext) throws WTException {
		...
		// In edit , we are reading enumeration and showing all values in combobox
		else if (modetype.equals(ComponentMode.EDIT)) {

			String funcOrg = "State";
 ...
 * targetFile="codebase/service.properties"> <Option
 * serviceClass="ext.custom.datautility.DropDownUtility"
 * requestor="java.lang.Object" selector="EXTRA" cardinality="duplicate"/>
 * </Service>
 */