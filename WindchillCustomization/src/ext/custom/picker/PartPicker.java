...
public class PartPicker extends AbstractDataUtility {
	...
	public Object getDataValue(String componentId, Object datum, ModelContext mc) throws WTException {
		...
		if (ComponentMode.CREATE.equals(mode) || ComponentMode.EDIT.equals(mode)) {
			...
			PickerRenderConfigs.setDefaultPickerProperty(map, PickerRenderConfigs.PICKER_TITLE, "Find Mechanical Part");
			...
			/*PickerRenderConfigs.setDefaultPickerProperty(map, PickerRenderConfigs.BASE_WHERE_CLAUSE,
					"(Attribute1Name='" + "Attribute1Value" + "')|(Attr2Name='" + "Attr2Value" + "')"); */
