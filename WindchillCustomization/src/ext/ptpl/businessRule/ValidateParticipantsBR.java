...
public class ValidateParticipantsBR implements RuleValidation {
	private static final Logger LOGGER = LogR.getLoggerInternal(ValidateParticipantsBR.class.getName());
	...
	@Override
		public RuleValidationResult performValidation(RuleValidationKey arg0, RuleValidationObject arg1,
		    ...
		    // TODO Auto-generated method stub
		    System.out.println("*******ValidateParticipantsBR Started****");
			...
			if (targetObject instanceof WTPart) {
				...
				if ((!participantsValidation (cn))) {
					String[] errorMessage = { wtPart.getNumber() };
					ruleValidationResult = getValidationResult(objRef, arg0, errorMessage,
							"CHECK_AFFECTED_RESULTING_OBJECTS_MESSAGE");
				}
			}
	...
	public boolean participantsValidation (WTChangeOrder2 cn) throws ChangeException2, WTException {
