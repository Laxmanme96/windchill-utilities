...
public class GetConfiguratoinTypeDatautility extends DefaultDataUtility  {

	protected static final Logger logger = LogR.getLogger(GetConfiguratoinTypeDatautility.class.getName());
	
	@Override
	public Object getDataValue(String componentId, Object datum, ModelContext modelContext) throws WTException {
		System.out.println("GetConfiguratoinTypeDatautility STARTING...");

		String EnumInternamName = "ConfigurationType";
		ArrayList<String> internalValues = new ArrayList<String>();
		ArrayList<String> displayValues = new ArrayList<String>();

		Map<String, String> internalDisplayValues = getEnumInternalAndDisplayValues(EnumInternamName);
		...
		box.addJsAction("onChange", "GetConfigurationType()");
		return box;
	}
