...
public class AreaDU extends DefaultDataUtility {
	protected static final Logger logger = LogR.getLogger(AreaDU.class.getName());

	@Override
	public Object getDataValue(String str, Object paramObject, ModelContext modelContext) throws WTException {
		System.out.println("Area DataUtility STARTED");
