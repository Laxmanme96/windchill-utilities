...
public class APPLCreatePartWizardValidator extends CreatePartActionValidator {
	private final CustomProperties props = new CustomProperties(CustomProperties.VALIDATE);
	protected static final Logger logger = LogR.getLogger(APPLCreatePartWizardValidator.class.getName());
	...
	public UIValidationResult validateFormSubmission(UIValidationKey var1, UIValidationCriteria var2, Locale var3)
		...
		logger.debug("ENTERING APPLCreatePartWizardValidator.validateFormSubmission");
		...
		logger.debug("EXITING APPLCreatePartWizardValidator.validateFormSubmission");
		return result;
	}
}
