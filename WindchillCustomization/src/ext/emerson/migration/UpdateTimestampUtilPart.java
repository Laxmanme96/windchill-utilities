...
public class UpdateTimestampUtilPart {
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			// Print all records. Get part and update revs
	...
	public static void store(Record record, String create, String modify) throws Exception {
		...
		try {
			ResultSet resultset = statement1.executeQuery(
					"select d.idA2A2 id,dm.WTPartNumber num,d.versionIdA2versionInfo ver,d.iterationIdA2iterationInfo iter, d.modifyStampA2 modifyT, d.createStampA2 createT from WTPart d, WTPartMaster dm where d.idA3masterReference=dm.idA2A2 and dm.WTPartNumber='"
			...
			while (resultset.next()) {
				...
				int temp = statement2.executeUpdate("update WTPart set modifyStampA2='" + modify
